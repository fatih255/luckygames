...
const Home: NextPage = () => {
  ...
  return (
    <div >
      <Head>
        <title>Kripto Şans Oyunları</title>
        ...
        <div className="flex flex-row justify-around  items-center mx-auto">
          ...
          <div className="grid  sm:grid-cols-1 z-10 gap-3 mt-4 flex-[.7] ">
            ...
            <div className="bg-white flex px-4 py-4 justify-center items-center md:w-90 rounded-2xl centered-shadow cursor-default transition duration-1000 hover:translate-x-4 hover:z-20">
              <span className="text-blue-600 text-xl">Bütçenize Uygun Oyun Odalarından Birine Katılın</span>
            </div>
            <div className="bg-white flex px-4 py-4 justify-center items-center md:w-90 rounded-2xl centered-shadow cursor-default transition duration-1000 hover:translate-x-4 hover:z-20">
              <span className="text-blue-600 text-xl" >Kripto Cüzdanınızdan Oyuna Girebilmeniz İçin Gerekli Miktarı Yatırın</span>
            </div>
            <div className="bg-white flex px-4 py-4 justify-center items-center md:w-90 rounded-2xl centered-shadow cursor-default transition duration-1000 hover:translate-x-4 hover:z-20">
            ...
            <div className="bg-white  border-box   flex px-4 py-4 justify-center items-center md:w-90 rounded-2xl centered-shadow cursor-default transition duration-1000 hover:translate-x-10 hover:z-20">
              <span className="text-blue-600 text-xl" >Oyun Sonunda Kaybedenlerin Parasını Kazananlara Eşit Olarak Kripto Cüzdanınıza Yatıralım</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div>
            ...
            <div>
              <p className="text-lg border-purple-300 border-l-4 pl-4">
                Sistemimize kayıt olduktan sonra sayısı 20 ye yakın odalardan kendisine en uygun olan Etherium(ETH)'u seçti.
                Sonrasında oyuna 100 kişinin katıldığını gördü ve odaya katılıp ücreti 0,000001 gibi uygun bir fiyattı ve oyundaki para havuzuna kripto cüzdanından oyuna katılım için gerekli olan ücreti gönderdi.
                ...
                Oyunu kazanan kişiler 0,000001 yi 2x yapmış olurlar çünkü odada 100 kişilik oyun var ve sadece 50 kişi kalmış. Dolayısıyla oyundaki bakiyesinde 2x şeklinde bir uyarı görür
                Çünkü ilk raundu kazanmıştır. İsterse oyundan çekilebilir ve kripto cüzdanına aktarabilir. bunun için oyunu terkedecek kişilerin toplamı  çift olmalıdır ki geriye açıkta kalmayan oyuncu olmasın
